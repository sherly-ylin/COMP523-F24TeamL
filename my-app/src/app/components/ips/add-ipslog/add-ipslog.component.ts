  ...
  pages: [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title:
            'Hours spent in community with clients face-to-face, job development, meetings at VR, and driving time.',
          description: 'Enter a number.',
          isRequired: true,
          validators: [{ type: 'numeric', text: 'Value must be a number' }],
        },
        {
          ...
          title:
            'Hours spent in treatment team meetings and vocational unit meetings, writing notes/ documentation, phone calls, and supervision in office.',
          description: 'Enter a number.',
          isRequired: true,
          validators: [{ type: 'numeric', text: 'Value must be a number' }],
        },
