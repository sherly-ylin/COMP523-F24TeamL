  ...
  pages: [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          name: 'staff_name',
          title:
            'What was the name of the staff who have worked on the IPS team over the last 6 months?',
          isRequired: true,
        },
        {
          type: 'text',
        ...
        },
        {
          ...
          name: 'other_roles',
          title:
            'If the person has another role on the team, list it here and % of time spent in each role.',
        ...
        },
        {
          ...
          showOtherItem: true,
          choices: [
            'IPS 101 (IPS Works online course)',
            'Career Profile',
            'Job Development',
            'Documentation',
