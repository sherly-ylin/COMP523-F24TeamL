      ...
      elements: [
        {
          ...
          inputType: 'date',
          title:
            'What were the dates the IPS Staff participated in trainings/PTO? (MM/DD/YYYY)',
          isRequired: true,
        ...
        },
        {
          ...
          description:
            'i.e., in person, via telephone, email, individual served made contact, etc.',
          isRequired: true,
          choices: [
            'in person',
            'via telephone',
            'email',
            'individual served made contact',
          ],
          showOtherItem: true,
        },
        {
